...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="index.php">New Order</a>
            ...
            <div class="col-lg-6">
              <div class="card mb-3">
                ...
                <div id="qtypanel" hidden="">
                  ...
                  Observaciones: <input id="qty" size="15" maxlength="30" type="text" min="1" max="50" name="qty"  />
        ...
        <footer class="sticky-footer">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright © Software de Restaurante New Order</span>
            </div>
          </div>
        </footer>
